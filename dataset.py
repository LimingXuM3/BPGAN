...
class Dataset():
    ...
    def __init__(self, opt):
        ...
        #sort by zhanghe
        # self.A_paths.sort(key=lambda str: int(str.split("/")[-1].split(".")[0].split("_")[0]))
        # self.B_paths.sort(key=lambda str: int(str.split("/")[-1].split(".")[0].split("_")[0]))
    ...
    def __getitem__(self, index):
        ...
        #change to fixed pairs by zhanghe
